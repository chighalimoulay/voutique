...
export const products: Product[] = [
  ...
  // ⚠️ منتج حقيقي — عدّلي السعر أدناه إلى سعرك الفعلي
  {
    id: 'p-031',
  ...
  {
    id: 'p-035',
    name: 'مجموعة عطور Clive Dorris الزيتية',
    slug: 'clive-dorris-perfume-set',
    shortDescription: 'مجموعة من 4 عطور زيتية فاخرة خالية من الكحول.',
    description:
      'مجموعة عطور Clive Dorris الزيتية (Yara، Roll-on، My Way، Miss Lavarna)، كل عطر بحجم 20 مل، خالية من الكحول ومناسبة للاستخدام اليومي.',
    price: 0, // ⚠️ TODO: أدخلي السعر
    category: 'perfumes',
    brand: 'Clive Dorris',
    gender: 'women',
    image: '/images/products/clive-dorris-perfume-set.jpg',
    available: true,
    size: '4 × 20 مل',
  },
];
